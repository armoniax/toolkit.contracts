...
TBL plan_t {
    ...
    EOSLIB_SERIALIZE(plan_t, (id)(total_bbp_quota)(applied_bbp_quota)(fulfiled_bbp_quota)(min_sum_quant)(quants)(nfts)(created_at)(updated_at))
